...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = function render() {
	  _reactDom2.default.render(_react2.default.createElement(_Popup2.default, null), document.querySelector('#content'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueryBox = __webpack_require__(160);
	...
	var _ResultBox = __webpack_require__(162);
	...
	var Popup = (function (_Component) {
	  ...
	  _createClass(Popup, [{
	    ...
	    key: 'translation',
	    value: function translation(query) {
	      return new Promise(function (resolve, reject) {
	        if (query.trim() === '') return { translation: [] };

	        var timeout = 5000;
	        var callback = '__callback' + index++;
	        var url = 'https://fanyi.youdao.com/openapi.do?keyfrom=YoungdzeBlog&key=498418215&type=data&doctype=jsonp&version=1.1&q=' + encodeURIComponent(query.trim());
	    ...
	    value: function fetchTranslation() {
	      var _this2 = this;

	      if (this.state.query.trim() === '') return;
	      this.setState({ loading: true });
	      if (_store2.default.getState()[this.state.query.trim()]) return this.setState({
	        translation: _store2.default.getState()[this.state.query.trim()],
	        loading: false
	      });
	      this.translation(this.state.query.trim()).then(function (res) {
	        _this2.setState({
	          translation: res,
	          loading: false
	        });
	        _store2.default.dispatch((0, _actions.setQuery)(_this2.state.query, _this2.state.translation));
	      }).catch(function (err) {
	        _this2.setState({
	          translation: err,
	          loading: false
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_QueryBox2.default, { query: this.state.query, handleChange: this.handleChange.bind(this),
	          fetchTranslation: this.fetchTranslation.bind(this) }),
	        this.state.loading && _react2.default.createElement(_Loading2.default, null),
	        _react2.default.createElement(_ResultBox2.default, { translation: this.state.translation })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueryBox = (function (_Component) {
	  _inherits(QueryBox, _Component);

	  function QueryBox(props) {
	    _classCallCheck(this, QueryBox);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(QueryBox).call(this, props));
	  ...
	  _createClass(QueryBox, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'row', id: 'queryBox' },
	        _react2.default.createElement(
	          'form',
	          { action: 'get', name: 'dictForm', id: 'dictForm', className: 'col s12' },
	          _react2.default.createElement(
	            'div',
	            { className: 'row' },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('input', { type: 'text', id: 'query', name: 'query', ref: 'queryInput', className: 'validate', placeholder: 'Query',
	    ...
	    value: function protoTypes() {
	      return {
	        ...
	        fetchTranslation: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultBox = (function (_Component) {
	  _inherits(ResultBox, _Component);
	  ...
	  _createClass(ResultBox, [{
	    ...
	    value: function handleAdd() {
	      var query = this.props.translation.query;
	      this.addToWordbook(query);
	    }
	  }, {
	    key: 'addToWordbook',
	    value: function addToWordbook(query) {
	      var url = 'http://dict.youdao.com/wordbook/ajax?action=addword&q=' + query;
	      this.asyncGet(url).then(function (res) {
	        console.log(res);
	      }).catch(function (err) {});
	    }
	  }, {
	    key: 'asyncGet',
	    value: function asyncGet(url) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'row', id: 'resultBox' },
	        _react2.default.createElement(
	          'div',
	          { className: 'col s12' },
	          this.props.translation && _react2.default.createElement(
	            'div',
	            { className: 'card blue-grey darken-1' },
	            _react2.default.createElement(
	              'div',
	              { className: 'card-content white-text', id: 'resultField' },
	              _react2.default.createElement(
	                'div',
	                { className: 'card-title', id: 'basic' },
	                this.props.translation.basic && this.props.translation.basic.phonetic && _react2.default.createElement(
	                  'code',
	                  { className: 'pronoun' },
	                  '/',
	                  this.props.translation.basic.phonetic.split(';')[0],
	                  '/'
	                ),
	                this.props.translation.basic && this.props.translation.basic.explains && _react2.default.createElement('div', {
	                  dangerouslySetInnerHTML: { __html: this.props.translation.basic.explains.join('<br />') } }),
	                !this.props.translation.basic && this.props.translation.translation && this.props.translation.translation[0]
	              ),
	              this.props.translation.web && this.props.translation.web.map(function (w, key) {
	                return _react2.default.createElement(
	                  'p',
	                  { key: key, className: 'web-translation' },
	                  w.key,
	                  ': ',
	                  w.value.join(', ')
	                );
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: 'javascript:;', onClick: this.handleAdd.bind(this) },
	                '添加到有道单词本'
	              )
	            )
	          )
	    ...
	    value: function protoTypes() {
	      return {
	        translation: _react.PropTypes.object.isRequired
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = _store2.default.get('youdaoDict') || {};
	var SET = 'SET';
	...
	var dict = function dict() {
	  ...
	  switch (action.type) {
	    case SET:
	      ...
	      _store2.default.set('youdaoDict', dummy);
	      return dummy;
	    default:
	      return state;
	  }
	...
	var store = (0, _redux.createStore)(dict);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setQuery = exports.setQuery = function setQuery(query, translation) {
	  return {
	    type: _store.SET,
	    query: query,
